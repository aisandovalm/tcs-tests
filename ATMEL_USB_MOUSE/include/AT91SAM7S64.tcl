...
set AT91C_UDP_RMWUPE      [expr 0x1 <<  2 ]
...
set AT91C_SYSC_SYSC_VREG 0xFFFFFD60
...
# *****************************************************************************
set AT91C_BASE_SYSC      0xFFFFF000
...
array set SSC_att {
	...
	RC1R 	{ R AT91C_SSC_RC1R 	RW }
	TSHR 	{ R AT91C_SSC_TSHR 	RW }
	THR 	{ R AT91C_SSC_THR 	WO }
	TFMR 	{ R AT91C_SSC_TFMR 	RW }
	listeReg 	{ RFMR CMR IDR SR RC0R RSHR RHR TCMR RCMR CR IMR IER RC1R TSHR THR TFMR  }
...
array set TCB_att {
	BMR 	{ R AT91C_TCB_BMR 	RO }
	BCR 	{ R AT91C_TCB_BCR 	WO }
	listeReg 	{ BMR BCR  }

}

# ========== Peripheral attributes for SYSC peripheral ========== 
array set SYSC_att {
	VREG 	{ R AT91C_SYSC_SYSC_VREG 	 }
	listeReg 	{ VREG  }
...
array set US1_att {
	...
	listeReg 	{ XXR RHR IMR IER CR RTOR THR CSR IDR FIDI BRGR TTGR IF NER MR  }
...
array set US0_att {
	...
	listeReg 	{ TTGR BRGR RHR IMR NER RTOR XXR FIDI CR IER IF MR IDR CSR THR  }
...
array set UDP_att {
	...
	listeReg 	{ ISR IDR GLBSTATE FDR CSR RSTEP ICR IMR IER FADDR NUM  }
